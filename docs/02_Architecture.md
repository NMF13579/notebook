...
**Передача.** FTR-006 читает exact revision документа и переносит относящиеся к
задаче ограничения, стыки и проверки в существующий C-005; FTR-007 читает тот же
результат для contribution/dependencies и порядка внутренних работ. До его
готовности допустима подготовка плана с явной зависимостью; завершённость ADR
не снимает эту зависимость. Проверка полноты и согласованности описана в
...
для FTR-006/007. Он не является новым видом C-004.
