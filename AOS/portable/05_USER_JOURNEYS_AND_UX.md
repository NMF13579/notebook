...
artifact_role: USER_JOURNEYS_AND_UX_OWNER
status: DRAFT
authority: NONE
...
The source Product owner is byte-bound in [README.md](README.md) and remains authoritative for accepted journey/product facts. New interaction detail is `SYNTHESIZED_DRAFT`.
