...
artifact_role: FEATURE_SPECIFICATIONS_OWNER
status: DRAFT
authority: NONE
source_owner_identity: sha256:f0ade2e1f76368cc909302dae7d87f1e4b7297a23c44566aee06c84a1f2f0ea0
feature_count: 30
...
Этот документ даёт единый portable design-level view всех `FTR-001…FTR-030`. Исходный Feature inventory byte-bound в [README.md](README.md) и остаётся owner для identity, dossier baseline, synthesis recommendation и `human_disposition`. Детализация здесь:
