...
* существование targets из 00_INDEX.md;
...
Проверка generated index

Если 00_INDEX.md станет generated artifact, CI может проверять:

index соответствует canonical files
...
CI не должен скрыто переписывать index и commit его обратно.

Generated index остаётся derived navigation artifact.
