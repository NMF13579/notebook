---
artifact_id: AOS-DOCUMENTATION-TASK-SEQUENCE-R4
document_type: DOCUMENTATION_TASK_SEQUENCE
revision: R4
status: DRAFT
fact_class: PROPOSAL
correction_of: AOS-DOCUMENTATION-TASK-SEQUENCE-R3
audit_basis: AOS-DOCUMENTATION-TASK-SEQUENCE-R3-AUDIT-R1
supersedes_if_human_accepted:
  - AOS-DOCUMENTATION-TASK-SEQUENCE-R3
scope:
...
current_wave: W0
next_documentation_task: SEQ-DOC-001
---

# AOS — Последовательность создания документации по задачам R4
...
| Finding `R3 Audit` | Исправление в `R4` |
|---|---|
...
|---|---|
| Project identity, authority, statuses, Minimal Safety Floor | `00_Core.md` |
| Users, problems, product boundaries, journeys | `01_Product.md` |
| Layer boundaries, shared contract classes, data ownership | `02_Architecture.md` |
| Task stages, validation, review, recovery and Git boundaries | `03_Development.md` |
| Lessons and regression candidates | `04_Lessons.md` |
| Research routing and provenance | `05_Reference.md` |
| Feature inventory and dossiers | `06_Features.md` |
| Documentation sequence and dependency order | `R4` only after human acceptance |
...
Используется vocabulary владельца `00_Core.md`:
...
|---|---|---|
| `FTR-021` | SoT ownership уже задано `02_Architecture.md` | registry/authenticity enforcement после measured drift |
...
|---|---|---|
| `SEQ-DOC-001` | `AOS_Authoritative_Owner_Map_R1.md` | accepted baseline |
| `SEQ-DOC-002` | `AOS_Documentation_Task_Manifest_R1.md` | `SEQ-DOC-001` |
| `SEQ-DOC-003` | `AOS_Gate_Status_Usage_Profile_R1.md` | `00_Core.md`, `SEQ-DOC-001` |
| `SEQ-DOC-004` | `AOS_Feature_Coverage_Ledger_R1.md` | `06_Features.md` |
| `TASK-DOC-001` | `AOS_Portable_Task_Candidate_Contract_R1.md` | `02_Architecture.md`, `03_Development.md` |
...
После human acceptance `R4` необходимо создать:
...
- принимать `R4` без exact human decision;
...
Провести read-only audit exact `AOS_Documentation_Task_Sequence_R4.md`.
