...
artifact_role: PROJECT_CORE_REVIEW_VIEW
status: DRAFT
authority: NONE
canonical_owner: docs/00_Core.md
...
Этот документ сводит identity, mission, boundaries, authority semantics и общую терминологию будущего AOS для цельного human review. Canonical owner этих фактов — [docs/00_Core.md](../../docs/00_Core.md); при расхождении этот DRAFT уступает owner или более новому exact human decision.
