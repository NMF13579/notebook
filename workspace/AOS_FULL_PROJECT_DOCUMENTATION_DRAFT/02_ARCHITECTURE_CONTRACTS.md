...
artifact_role: ARCHITECTURE_CONTRACT_REVIEW_VIEW
status: DRAFT
authority: NONE
canonical_owner: docs/02_Architecture.md
accepted_foundation: AOS/02_ARCHITECTURE_CONTRACTS.md
...
Документ сводит target architecture AOS на уровне WHAT: layers, responsibilities, semantic contracts, ownership, invariants, failure and trust boundaries. Canonical owner — [docs/02_Architecture.md](../../docs/02_Architecture.md); accepted frozen foundation — [AOS/02_ARCHITECTURE_CONTRACTS.md](../../AOS/02_ARCHITECTURE_CONTRACTS.md).
...
- atomic/journaled boundary where material;
...
| unexpected mutation | stop; preserve journal/diff; reconcile and review |
